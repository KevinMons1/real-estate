...
const AttractionToContentFull = () => {
    return (
        <>
            <section className='section__attraction-to-content-full'>
                <div className="section__attraction-to-content-full__container full">
                    <div className="flex flex--center flex--column full">
                        ...
                        <button className='button__primary button__primary--secondary'>Learn more</button>
                    </div>
                </div>
            </section>
        </>
...
export default AttractionToContentFull;